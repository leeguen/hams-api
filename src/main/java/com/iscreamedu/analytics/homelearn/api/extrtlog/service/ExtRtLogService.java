...
public interface ExtRtLogService {
	...
	public LinkedHashMap setFnObjectRewardMmc(Map<String, Object> params) throws Exception;
	
	public LinkedHashMap resetObjectRewardMmc(Map<String, Object> params) throws Exception;
